...
public class SPVisitEntity extends Packet {
    ...
    public void read(ByteBuf buffer, INetHandler netHandler) {
        ...
        if (RequestsFilterHelper.getLock(CommonReference.getPersistentUUID(playerMP), MerchantsMain.ENTITY_MANAGEMENT_REQUEST_ID)) {
            ...
            OxygenHelperServer.addRoutineTask(()->MerchantsManagerServer.instance().getBoundEntitiesManager().visitEntity(playerMP, bondId));
        }
    }
}
