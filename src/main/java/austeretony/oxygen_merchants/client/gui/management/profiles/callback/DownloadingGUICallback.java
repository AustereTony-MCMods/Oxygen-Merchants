...
public class DownloadingGUICallback extends AbstractGUICallback {
    ...
    public DownloadingGUICallback(ManagementMenuGUIScreen screen, ProfilesManagementGUISection section, int width, int height) {
    ...
    public void handleElementClick(AbstractGUISection section, GUIBaseElement element, int mouseButton) {
        if (mouseButton == 0) { 
            if (element == this.cancelButton)
                ...
                MerchantsManagerClient.instance().downloadProfilesData();
                this.close();
            }
        }
    }
