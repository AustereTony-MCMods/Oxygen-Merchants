...
public class ProfileNameEditGUICallback extends AbstractGUICallback {
    ...
    public void init() {
        ...
        this.addElement(new GUITextLabel(2, 2).setDisplayText(I18n.format("merchants.gui.management.nameEditingCallback"), true, GUISettings.instance().getTitleScale()));   
        ...
        this.addElement(this.confirmButton = new GUIButton(15, this.getHeight() - 12, 40, 10).setSound(OxygenSoundEffects.BUTTON_CLICK.soundEvent).enableDynamicBackground().setDisplayText(I18n.format("oxygen.gui.confirmButton"), true, GUISettings.instance().getButtonTextScale()).disable());
    ...
    protected void onOpen() {
        this.nameField.setText(this.oldName = MerchantsManagerClient.instance().getMerchantProfilesManager().getProfile(this.section.getCurrentProfileButton().id).getName());
    }
