...
public class SaveChangesCallback extends AbstractGUICallback {
    ...
    public SaveChangesCallback(ManagementScreen screen, MerchantProfilesSection section, int width, int height) {
    ...
    public void init() {
        ...
        this.addElement(new OxygenTextLabel(4, 12, ClientReference.localize("oxygen_merchants.gui.management.callback.saveChanges"), EnumBaseGUISetting.TEXT_SCALE.get().asFloat(), EnumBaseGUISetting.TEXT_ENABLED_COLOR.get().asInt()));
        this.addElement(new OxygenTextLabel(6, 23, ClientReference.localize("oxygen_merchants.gui.management.callback.saveChanges.request"), EnumBaseGUISetting.TEXT_SUB_SCALE.get().asFloat(), EnumBaseGUISetting.TEXT_ENABLED_COLOR.get().asInt()));
    ...
    private void confirm() {
        MerchantsManagerClient.instance().getMerchantProfilesManager().saveProfileChangesSynced(this.section.getCurrentProfileChangesBuffer().copy());
        this.close();
    }
