...
public class RemoveEntryCallbackGUIFiller extends BackgroundGUIFiller {

    public RemoveEntryCallbackGUIFiller(int xPosition, int yPosition, int width, int height) {             
        super(xPosition, yPosition, width, height, ManagementMenuGUIScreen.REMOVE_ENTRY_CALLBACK_BACKGROUND);
    }
