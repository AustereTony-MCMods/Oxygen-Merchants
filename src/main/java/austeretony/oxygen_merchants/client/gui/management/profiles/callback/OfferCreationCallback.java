...
public class OfferCreationCallback extends AbstractGUICallback {
    ...
    public OfferCreationCallback(ManagementScreen screen, MerchantProfilesSection section, int width, int height) {
    ...
    public void init() {
        ...
        this.addElement(new OxygenTextLabel(4, 12, ClientReference.localize("oxygen_merchants.gui.management.callback.offerCreation"), EnumBaseGUISetting.TEXT_SCALE.get().asFloat(), EnumBaseGUISetting.TEXT_ENABLED_COLOR.get().asInt()));
    ...
    private void confirm() {
        MerchantOffer offer = new MerchantOffer(System.currentTimeMillis(), ItemStackWrapper.getFromStack(this.currentEntry.getItemStack()));
