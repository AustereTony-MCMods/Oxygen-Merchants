...
public class RemoveProfileCallbackGUIFiller extends BackgroundGUIFiller {

    public RemoveProfileCallbackGUIFiller(int xPosition, int yPosition, int width, int height) {             
        super(xPosition, yPosition, width, height, ManagementMenuGUIScreen.REMOVE_PROFILE_CALLBACK_BACKGROUND);
    }
