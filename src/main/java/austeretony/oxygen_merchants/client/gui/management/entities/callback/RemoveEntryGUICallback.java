...
public class RemoveEntryGUICallback extends AbstractGUICallback {
    ...
    @Override
    public void init() {
        this.addElement(new RemoveEntryCallbackGUIFiller(0, 0, this.getWidth(), this.getHeight()));
        this.addElement(new GUITextLabel(2, 2).setDisplayText(ClientReference.localize("oxygen_merchants.gui.management.bondRemoveCallback"), true, GUISettings.instance().getTitleScale()));
    ...
    protected void onOpen() {
        this.requestLabel.setDisplayText(ClientReference.localize("oxygen_merchants.gui.management.bondRemoveCallback.request", 
