...
public class GUICurrency extends GUISimpleElement<GUICurrency> {
    ...
    public void draw(int mouseX, int mouseY) {
        if (this.isEnabled()) {
            ...
            if (this.useCurrency) {
                ...
                this.mc.fontRenderer.drawString(I18n.format("oxygen.currency.gold"), 0, 0, this.getEnabledTextColor(), false);
    ...
    public void drawTooltip(int mouseX, int mouseY) {
        if (!this.useCurrency && mouseX >= this.getX() && mouseY >= this.getY() && mouseX < this.getX() + 8 && mouseY < this.getY() + 8)
