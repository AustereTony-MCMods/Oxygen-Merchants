...
public class ProfileNameEditCallback extends AbstractGUICallback {
    ...
    public ProfileNameEditCallback(ManagementScreen screen, MerchantProfilesSection section, int width, int height) {
    ...
    public void init() {
        ...
        this.addElement(new OxygenTextLabel(4, 12, ClientReference.localize("oxygen_merchants.gui.management.callback.editName"), EnumBaseGUISetting.TEXT_SCALE.get().asFloat(), EnumBaseGUISetting.TEXT_ENABLED_COLOR.get().asInt()));
        this.addElement(new OxygenTextLabel(6, 23, ClientReference.localize("oxygen_merchants.gui.management.callback.editName.request"), EnumBaseGUISetting.TEXT_SUB_SCALE.get().asFloat(), EnumBaseGUISetting.TEXT_ENABLED_COLOR.get().asInt()));
    ...
    protected void onOpen() {
        this.nameField.setText(MerchantsManagerClient.instance().getMerchantProfilesContainer().getProfile(this.section.getCurrentProfileEntry().index).getName());
    }
