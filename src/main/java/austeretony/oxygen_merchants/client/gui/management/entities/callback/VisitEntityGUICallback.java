...
public class VisitEntityGUICallback extends AbstractGUICallback {
    ...
    public void init() {
        ...
        this.addElement(new GUITextLabel(2, 2).setDisplayText(I18n.format("merchants.gui.management.visitEntityCallback"), true, GUISettings.instance().getTitleScale()));
    ...
    protected void onOpen() {
        this.requestLabel.setDisplayText(I18n.format("merchants.gui.management.visitEntityCallback.request", 
    ...
    public void handleElementClick(AbstractGUISection section, GUIBaseElement element, int mouseButton) {      
        if (mouseButton == 0) { 
            if (element == this.cancelButton)
                ...
                MerchantsManagerClient.instance().getBoundEntitiesManager().visitEntitySynced(this.section.getCurrentBondButton().id);
                this.close();
                this.screen.close();
            }
        }
