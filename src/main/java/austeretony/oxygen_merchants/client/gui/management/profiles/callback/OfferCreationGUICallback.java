...
public class OfferCreationGUICallback extends AbstractGUICallback {
    ...
    public void init() {
        ...
        this.addElement(this.sellingOnlyButton = new GUICheckBoxButton(2, 159, 6).setSound(OxygenSoundEffects.BUTTON_CLICK.soundEvent)
        ...
        this.addElement(new GUITextLabel(12, 158).setDisplayText(ClientReference.localize("oxygen_merchants.gui.management.sellingOnly"), true, GUISettings.instance().getSubTextScale()));
