...
public class OfferCreationGUICallback extends AbstractGUICallback {
    ...
    public void init() {
        ...
        this.addElement(new OxygenGUIText(4, 5, ClientReference.localize("oxygen_merchants.gui.management.callback.offerCreation"), GUISettings.get().getTextScale(), GUISettings.get().getEnabledTextColor()));
    ...
    public void handleElementClick(AbstractGUISection section, GUIBaseElement element, int mouseButton) {
        if (mouseButton == 0) { 
            if (element == this.cancelButton)
                ...
                MerchantOffer offer = new MerchantOffer(System.currentTimeMillis(), ItemStackWrapper.getFromStack(this.currentButton.getItemStack()));
