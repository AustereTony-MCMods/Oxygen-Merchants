...
public class OfferCreationGUICallback extends AbstractGUICallback {
    ...
    public void init() {
        ...
        this.addElement(this.amountField = new GUITextField(3, 108, 60, 10).setScale(0.7F).setText("1").enableNumberFieldMode(Integer.MAX_VALUE));
        ...
        this.addElement(this.buyCostField = new GUITextField(3, 128, 60, 10).setScale(0.7F).setText("0").enableNumberFieldMode(Integer.MAX_VALUE));
        ...
        this.addElement(this.sellingCostField = new GUITextField(3, 148, 60, 10).setScale(0.7F).setText("0").enableNumberFieldMode(Integer.MAX_VALUE).disable());
