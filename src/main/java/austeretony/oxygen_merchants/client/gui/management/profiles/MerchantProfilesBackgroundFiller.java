...
public class MerchantProfilesBackgroundFiller extends OxygenBackgroundFiller {

    public MerchantProfilesBackgroundFiller(int xPosition, int yPosition, int width, int height) {             
